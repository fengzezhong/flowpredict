...
# load the dataset
dataframe = read_csv('../../lte_flow/trainDataForDay/lteFlowOfDay_guizhou.csv', usecols=[3], engine='python',
                     skipfooter=0)
...
for i in range(-7, 0):
    with codecs.open(osPath + '/lte_flow/predictFlow_day/' + 'predictFlow_guizhou.csv', 'a+') as f0:

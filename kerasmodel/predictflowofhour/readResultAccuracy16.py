...
f_train = open(root + '/flowPredict/lte_flow/realline/kerasdata_train_' + citydata + '16.csv')
f_predict = open(root + '/flowPredict/lte_flow/realline/predictData' + citydata + '_keras16.csv')
...
filename = root + '/flowPredict/lte_flow/predictFlow_hour/predictAccuracyOf' + citydata + 'keras16.csv'

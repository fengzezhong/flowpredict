...
dataframe = read_csv(root + '/flowPredict/lte_flow/trainDataForReal/lteFlowOf' + citydata + 'Real_.csv', usecols=[3],
...
for i in range(-24, 0):
    with codecs.open(root + '/flowPredict/lte_flow/predictFlow_hour/' + 'predictFlow_' + citydata + '_hour.csv',
                     'a+') as f0:

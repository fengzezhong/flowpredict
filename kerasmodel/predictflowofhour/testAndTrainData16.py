...
dataframe = read_csv(root + '/flowPredict/lte_flow/realline/kerasdata_train_' + citydata + '16.csv', usecols=[3],
                     engine='python',
                     skipfooter=0)
...
for i in range(-16, 0):
    with codecs.open(root + '/flowPredict/lte_flow/realline/predictData' + citydata + '_keras16.csv', 'a+') as f0:

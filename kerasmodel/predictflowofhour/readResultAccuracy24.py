...
f_train = open(root + '/flowPredict/lte_flow/realline/kerasdata_train_'+citydata+'24.csv')
f_predict = open(root + '/flowPredict/lte_flow/realline/predictData' + citydata + '_keras24.csv')
...
filename = root + '/flowPredict/lte_flow/predictFlow_hour/predictAccuracyOf' + citydata + 'keras24.csv'

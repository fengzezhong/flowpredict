...
def file_handle_and_predict_min(file_path, work_id, type, is_train):
    ...
    def file_handle_and_predict_min_asyn(file_path, work_id, type, is_train):
    ...
    _thread.start_new_thread(file_handle_and_predict_min_asyn, (file_path, work_id, type, is_train))
